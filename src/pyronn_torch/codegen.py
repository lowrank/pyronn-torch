...
try:
    ...
    FUNCTIONS = {
            'Cone_Backprojection3D_Kernel_Launcher': CustomFunctionCall(
                ...
                *[FieldShapeSymbol(['projection'], i) for i in range(2, 0, -1)],
                TypedSymbol('projection_multiplier',
                            ...
                            fields_accessed=[volume, projection, projection_matrices], 
                            custom_signature="""
                                            ...
                                            """),  # noqa
            'Cone_Projection_Kernel_Launcher': CustomFunctionCall(
                ...
                *[FieldShapeSymbol(['projection'], i) for i in range(2, 0, -1)],
                ...
                custom_signature="""
                                ...
                                """),  # noqa
            'Cone_Projection_Kernel_Tex_Interp_Launcher': CustomFunctionCall(
                ...
                *[FieldShapeSymbol(['projection'], i) for i in range(2, 0, -1)],
                ...
                custom_signature="""
                                ...
                                """),  # noqa
                'Parallel_Projection2D_Kernel_Launcher': CustomFunctionCall(
                    ...
                    *[FieldShapeSymbol(['volume_slice'], i) for i in range(1, -1, -1)],
                    ...
                    backend='gpucuda',
                    fields_accessed=[volume_slice, projections_1d, ray_vectors], 
                    custom_signature="""
                                    ...
                                    """),  # noqa
                'Parallel_Backprojection2D_Kernel_Launcher': CustomFunctionCall(
...
def generate_shared_object(
    ...
    copytree(
        join(dirname(__file__), 'PYRO-NN-Layers', 'helper_headers'),
    ...
    extension = module.compile(
        extra_source_files=cuda_sources,
        extra_cuda_flags=['-arch=sm_52'],
        with_cuda=True,
